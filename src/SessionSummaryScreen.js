              ...
              <View key={i} style={s.drillRow}>
                ...
                {isEditing ? (
                  <View style={{ flex: 1, gap: 4 }}>
                    ...
                    }} placeholder={t('session_summary.drill_name_placeholder')} placeholderTextColor="#9CA3AF" />
                    {!drillStr && (
                      <TextInput style={s.editInput} value={desc} onChangeText={v => {
                        const arr = [...(editSummary.drills || [])]
                        arr[i] = { ...arr[i], description: v }
                        setEditSummary(prev => ({ ...prev, drills: arr }))
                      }} placeholder={t('session_summary.drill_desc_placeholder')} placeholderTextColor="#9CA3AF" />
                    )}
                  </View>
                ) : (
                  <View style={{ flex: 1 }}>
          ...
          <>
            {!isSent && (
              <TouchableOpacity style={s.editBtn} onPress={() => setIsEditing(true)}>
                <Ionicons name="pencil-outline" size={18} color={G} />
...
const s = StyleSheet.create({
  ...
  retryBtn: { backgroundColor: G, borderRadius: 10, paddingHorizontal: 20, paddingVertical: 10, marginTop: 8 },
  ...
  sentBadge: { backgroundColor: '#E8F5E9', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  sentBadgeTxt: { fontSize: 12, fontWeight: '600', color: G },
  scroll: { flex: 1 },
  ...
  editInput: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E0E5E0', borderRadius: 8, padding: 10, fontSize: 14, color: '#1a1a1a' },
  addBtn: { marginTop: 6, alignSelf: 'flex-start' },
  addBtnTxt: { fontSize: 13, fontWeight: '600', color: G },
  bottomActions: { flexDirection: 'row', gap: 10, padding: 16, backgroundColor: '#fff', borderTopWidth: 0.5, borderTopColor: '#E5E7EB' },
  editBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: '#E5E7EB' },
  editBtnTxt: { fontSize: 15, fontWeight: '600', color: G },
  sendBtn: { flex: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 12, backgroundColor: G },
  ...
  cancelBtnTxt: { fontSize: 15, fontWeight: '600', color: '#6B7280' },
  ...
  modalTitle: { fontSize: 16, fontWeight: '700', color: '#1a1a1a', marginBottom: 8 },
  modalBody: { fontSize: 14, color: '#6B7280', marginBottom: 16, lineHeight: 20 },
  ...
  modalBtnSend: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: G, alignItems: 'center' },
  modalBtnSendTxt: { fontSize: 15, fontWeight: '700', color: '#fff' },
})
